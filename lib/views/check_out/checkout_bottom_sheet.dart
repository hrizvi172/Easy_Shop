...
class _CheckoutBottomSheetState extends State<CheckoutBottomSheet> {
            ...
            for (int i = 0; i < gv.userCart.length; i++) {
              tempCart.add(
                map = {
                  ...
                  'total':
                      gv.userCart[i].quantity * gv.userCart[i].product.price,
                },
              );
            }
            ...
            children: <Widget>[
              ...
              InkWell(
                child: checkoutRow(
                  ...
                  widget.TotalSection,
                  false,
                  trailingText: '${(gv.total).toString()} EURO',
                ),
                onTap: () {
                  setState(() {
                    widget.addressSection = false;
  ...
  Widget getDivider() {
    return const Divider(thickness: 1, color: Color(0xFFE2E2E2));
  }
