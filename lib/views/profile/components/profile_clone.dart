...
class ProfileClone extends StatelessWidget {
  final User? u;
  const ProfileClone({Key? key, required this.u}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                ...
                Align(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    u?.isAnonymous ?? false ? 'Welcome Back' : ' ',
                    maxLines: 3,
                    softWrap: false,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                SizedBox(height: getProportionateScreenHeight(25)),
                ProfButton(
                  u?.isAnonymous ?? false ? 'Sign-In' : 'Log-Out',
                  u?.isAnonymous ?? false ? Icons.login : Icons.logout,
                ),
              ],
            ),
          ),
  ...
  return ElevatedButton.icon(
    ...
    label: Row(
      ...
      children: [
        ...
        const Icon(Icons.arrow_forward_ios, color: SecondaryColorDark),
      ],
    ),
