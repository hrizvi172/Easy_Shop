  ...
  Widget build(BuildContext context) {
    return Timeline.tileBuilder(
      ...
      theme: TimelineThemeData(
        ...
        connectorTheme: const ConnectorThemeData(space: 20.0, thickness: 4.5),
      ),
      builder: TimelineTileBuilder.connected(
        connectionDirection: ConnectionDirection.before,
        itemExtentBuilder: (_, __) =>
            getProportionateScreenWidth(325) / _processes.length,
        ...
        indicatorBuilder: (_, index) {
          ...
          if (index < _processIndex) {
            color = completeColor;
            child = const Icon(Icons.check, color: Colors.white, size: 13.0);
          } else {
            color = todoColor;
          }
          ...
          if (index <= _processIndex) {
            return Stack(
              children: [
                ...
                DotIndicator(size: 28.0, color: color, child: child),
              ],
            );
          } else {
            return Stack(
...
final _processes = ['Ordered', 'Processed', 'Delivered'];
